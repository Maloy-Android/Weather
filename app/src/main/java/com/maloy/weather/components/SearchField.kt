...
import com.maloy.weather.utils.app.rememberVoiceInput
...
fun SearchField(
    ...
    val (startVoiceInput, isVoiceInputAvailable) = rememberVoiceInput(
        onResult = { recognizedText ->
            ...
            onSearchTextChange(recognizedText)
        }
    )
    ...
    OutlinedTextField(
        ...
        onValueChange = { newTextFieldValue ->
            ...
            onSearchTextChange(newTextFieldValue.text)
        },
        modifier = modifier
            .fillMaxWidth()
        ...
        trailingIcon = {
            if (searchText.isEmpty() && isVoiceInputAvailable) {
                IconButton(
